...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=AdventureWorks2019;Data Source=HOMEPC2022\\SQL2019");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AspnetApplication>(entity =>
            {
                entity.HasKey(e => e.ApplicationId)
                    .HasName("PK__aspnet_A__C93A4C9881708CA0")
                    .IsClustered(false);
            ...
            modelBuilder.Entity<AspnetMembership>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__aspnet_M__1788CC4DFDA181B9")
                    .IsClustered(false);
                ...
                entity.HasOne(d => d.Application)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__aspnet_Me__Appli__3E3D3572");

                entity.HasOne(d => d.User)
                    .WithOne(p => p.AspnetMembership)
                    .HasForeignKey<AspnetMembership>(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__aspnet_Me__UserI__3F3159AB");
            });

            modelBuilder.Entity<AspnetPath>(entity =>
            {
                entity.HasKey(e => e.PathId)
                    .HasName("PK__aspnet_P__CD67DC58D4D99539")
                    .IsClustered(false);
                ...
                entity.HasOne(d => d.Application)
                    ...
                    .HasForeignKey(d => d.ApplicationId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__aspnet_Pa__Appli__40257DE4");
            });

            modelBuilder.Entity<AspnetPersonalizationAllUser>(entity =>
            {
                entity.HasKey(e => e.PathId)
                    .HasName("PK__aspnet_P__CD67DC59DB4BEC29");
                ...
                entity.HasOne(d => d.Path)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__aspnet_Pe__PathI__4119A21D");
            });

            modelBuilder.Entity<AspnetPersonalizationPerUser>(entity =>
            {
                entity.HasKey(e => e.Id)
                    .HasName("PK__aspnet_P__3214EC06567BEF74")
                    .IsClustered(false);
                ...
                entity.HasOne(d => d.Path)
                    ...
                    .HasConstraintName("FK__aspnet_Pe__PathI__420DC656");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.AspnetPersonalizationPerUsers)
                    .HasForeignKey(d => d.UserId)
                    .HasConstraintName("FK__aspnet_Pe__UserI__4301EA8F");
            });

            modelBuilder.Entity<AspnetProfile>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__aspnet_P__1788CC4CDAD01FC4");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__aspnet_Pr__UserI__43F60EC8");
            });

            modelBuilder.Entity<AspnetRole>(entity =>
            {
                entity.HasKey(e => e.RoleId)
                    .HasName("PK__aspnet_R__8AFACE1B374C3FF8")
                    .IsClustered(false);
                ...
                entity.HasOne(d => d.Application)
                    ...
                    .HasForeignKey(d => d.ApplicationId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__aspnet_Ro__Appli__44EA3301");
            });

            modelBuilder.Entity<AspnetSchemaVersion>(entity =>
            {
                entity.HasKey(e => new { e.Feature, e.CompatibleSchemaVersion })
                    .HasName("PK__aspnet_S__5A1E6BC1334E573C");
            });

            modelBuilder.Entity<AspnetUser>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__aspnet_U__1788CC4D98EA89D1")
                    .IsClustered(false);
                ...
                entity.HasOne(d => d.Application)
                    ...
                    .HasForeignKey(d => d.ApplicationId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__aspnet_Us__Appli__45DE573A");

                entity.HasMany(d => d.Roles)
                    .WithMany(p => p.Users)
                    .UsingEntity<Dictionary<string, object>>(
                        "AspnetUsersInRole",
                        l => l.HasOne<AspnetRole>().WithMany().HasForeignKey("RoleId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__aspnet_Us__RoleI__46D27B73"),
                        r => r.HasOne<AspnetUser>().WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK__aspnet_Us__UserI__47C69FAC"),
                        j =>
                        {
                            j.HasKey("UserId", "RoleId").HasName("PK__aspnet_U__AF2760AD1EC2963C");
            ...
            modelBuilder.Entity<AspnetWebEventEvent>(entity =>
            {
                entity.HasKey(e => e.EventId)
                    .HasName("PK__aspnet_W__7944C8106260B5CB");
            ...
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__Membersh__1788CC4C194D396C");
            ...
            modelBuilder.Entity<Parent>(entity =>
            {
                ...
                entity.HasMany(d => d.StudentsUsers)
                    .WithMany(p => p.ParentsUsers)
                    .UsingEntity<Dictionary<string, object>>(
                        "ParentStudent",
                        l => l.HasOne<Student>().WithMany().HasForeignKey("StudentsUserId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_ParentStudent_Student"),
                        r => r.HasOne<Parent>().WithMany().HasForeignKey("ParentsUserId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("FK_ParentStudent_Parent"),
                        j =>
                        {
                            ...
                            j.IndexerProperty<Guid>("ParentsUserId").HasColumnName("Parents_UserId");

                            j.IndexerProperty<Guid>("StudentsUserId").HasColumnName("Students_UserId");
                        });
            });
            ...
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__Profiles__1788CC4C263CB42D");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasMany(d => d.Roles)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("UserId", "RoleId").HasName("PK__UsersInR__AF2760AD4321B5C4");
