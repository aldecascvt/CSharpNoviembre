...
namespace AdventureWorks.Web.MVC.Controllers
{
    public class CustomersController : Controller
    {
        private readonly AdventureWorksDbContext _context;

        public CustomersController(AdventureWorksDbContext context)
        {
            _context = context;
        }
        ...
        {
            var adventureWorksDbContext = _context.Customers.Include(c => c.Person).Include(c => c.Store).Include(c => c.Territory);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AdventureWorksDbContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
